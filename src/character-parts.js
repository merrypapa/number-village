...
bump( 0.44, -0.14, 0.88, -0.032, 0.40);   // 눈두덩 — 아주 살짝만 들어감(인형은 부드럽다)
bump(-0.44, -0.14, 0.88, -0.032, 0.40);
bump( 0.52, -0.50, 0.68,  0.080, 0.56);   // 볼 — 통통하게
bump(-0.52, -0.50, 0.68,  0.080, 0.56);
bump( 0.00, -0.74, 0.67,  0.070, 0.60);   // 턱·볼살 — 볼과 이어져 둥글게
bump( 0.00, -0.52, 0.85,  0.014, 0.30);   // 입 둘레 아주 살짝
bump( 0.00,  0.62, 0.78, -0.014, 0.44);   // 이마는 살짝 평평하게
bump( 0.00, -1.00, 0.00, -0.050, 0.46);   // 턱 밑만 살짝 안으로
bump( 0.00,  0.00, -1.00, -0.035, 0.70);  // 뒤통수 쪽은 살짝 작게
