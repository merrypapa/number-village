...
//    bodyR   : 몰고 다니는 탈것의 몸 굵기 (말 1.8, 헤엄 1.0). drive일 때만.
//    track(pos, yaw) : 몰고 다니다 움직인 뒤 enter/exit 자리를 직접 정한다 (헤엄).
//    transfers : 탄 채로 갈아탈 수 있는 놀이기구 목록 (헤엄 → 🦆 오리배).
//    offTo   : 내리기를 누르면 내리는 대신 이 놀이기구로 갈아탄다 (오리배 → 헤엄).
// ===========================================================
